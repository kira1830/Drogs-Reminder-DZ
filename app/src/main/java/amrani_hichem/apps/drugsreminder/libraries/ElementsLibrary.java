...
import amrani_hichem.apps.drugsreminder.elements.DelayedReminder;
import amrani_hichem.apps.drugsreminder.elements.Drug;
import amrani_hichem.apps.drugsreminder.elements.IReminder;
import amrani_hichem.apps.drugsreminder.elements.Meal;
import amrani_hichem.apps.drugsreminder.elements.Reminder;
import amrani_hichem.apps.drugsreminder.util.BitmapCoder;
