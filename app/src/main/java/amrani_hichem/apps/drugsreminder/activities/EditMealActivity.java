...
public class EditMealActivity extends EditElementActivity<Meal> {
	...
	protected void loadViews(Bundle savedInstanceState) {
		...
		editTime.setHour(savedInstanceState.getInt("hour"));
		editTime.setMinute(savedInstanceState.getInt("minute"));
	}
	@Override
	...
	protected void onSaveInstanceState(Bundle outState) {
		...
		outState.putInt("hour", editTime.getHour());
		outState.putInt("minute", editTime.getMinute());
	}
	@Override
