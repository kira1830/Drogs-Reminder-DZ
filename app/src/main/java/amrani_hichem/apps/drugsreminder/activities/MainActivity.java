...
import amrani_hichem.apps.drugsreminder.libraries.Initializer;
import amrani_hichem.apps.drugsreminder.preferences.Preferences;
import amrani_hichem.apps.drugsreminder.adapters.SectionsPagerAdapter;
import amrani_hichem.apps.drugsreminder.receivers.GuardReceiver;
import amrani_hichem.apps.drugsreminder.util.PermissionPageUtils;
