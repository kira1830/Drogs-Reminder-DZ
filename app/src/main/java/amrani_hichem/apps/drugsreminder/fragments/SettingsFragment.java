package amrani_hichem.apps.drugsreminder.fragments;
...
import amrani_hichem.apps.drugsreminder.activities.AboutActivity;

import amrani_hichem.apps.drugsreminder.preferences.Preferences;
import amrani_hichem.apps.drugsreminder.util.AutoStartPageUtils;
